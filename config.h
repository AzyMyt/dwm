...
static const int barspacey		= 30;    /* how far to space the bar vertically */
static const int barspacex		= 400;    /* how far to space the bar horizontally */

static const int baroverlay		= 1;	    /* 0 means the bar will resize the work space */
...
static const char col5[] 		= "#ff0000";

static const char *colors[][3] = {
	/*               fg    bg    border   */
	[SchemeNorm] = { col3, col1, col3 },
	[SchemeSel]  = { col5, col4, col5 },
};
static const unsigned int alphas[][3]      = {
	/*               fg      bg        border*/
	[SchemeNorm] = { OPAQUE, baralpha, 0x30 },
